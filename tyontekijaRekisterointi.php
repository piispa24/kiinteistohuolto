...
<main class="form-signin w-50 m-auto">
  <form method="POST" action="tyontekijaRekisterointi.php">
    ...
    <div class="form-floating">
      <input name="kaytettavyys" type="text" class="form-control" id="floatingInput" value="3">
      <label for="floatingPassword">Käytettävyys</label>
    </div>
    <div class="form-floating">
      <input name="rooli" type="text" class="form-control" id="floatingInput" value="2">
      <label for="floatingInput">Rooli</label>
    </div>
    

    <button name="submit" class="w-100 btn btn-lg btn-primary" type="submit">Lisää työntekijä</button>
