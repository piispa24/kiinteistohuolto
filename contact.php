    ...
    <div class="container">
        ...
        <div id="contactBg" class="container mt-5 bg-light p-5">
            ...
            <div class="mb-1">
                ...
                <input type="text" class="form col-sm-4 inputSarake" id="yhteysNimi" placeholder="Nimesi" name="nimi">
            </div>
            <div class="mb-1 mt-1">
                <label for="email" class="form-label"></label><br>
                <input type="text" class="form col-sm-4 inputSarake" id="yhteysEmail" placeholder="Sähköposti" name="email">
            </div>
            <div class="mb-5 mt-1">
                <label for="puhnro" class="form-label"></label><br>
                <input type="text" class="form col-sm-4 inputSarake" id="yhteysPuhelinnro" placeholder="Puhelin numero" name="puhnro">
            </div>  
            <h5>Asia:</h5>  
            <div class="mb-1 mt-4">
                <label for="otsikko" class="form-label"></label>
                <input type="text" class="form col-sm-4 inputSarake" id="yhteysOtsikko" placeholder="Otsikko (Esim. Tarjouspyyntö)" name="otsikko">
            </div>
            <div class="mb-3 mt-3">
                <label for="asia" class="form-label"></label>
                <textarea type="text" class="form-control inputSarake" id="yhteysAsia" placeholder="Asia" name="asia" rows="5"></textarea>
            </div>
