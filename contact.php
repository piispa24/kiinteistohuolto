...
<div class="container-fluid container-index vh-100 p-3">
    <div class="container-fluid d-flex align-items-center justify-content-center">
        <div id="contactBg" class="yhtform bg-light text-dark p-3 col-sm-6">
            <h3 class="mb-4">Yhteydenottolomake</h3>
                ...
                <button name="talleta" id="yhteysBtn" type="submit" class="btn btn-success mt-1">Lähetä yhteydenotto</button>
                </form>
        </div>
    </div>
</div>
